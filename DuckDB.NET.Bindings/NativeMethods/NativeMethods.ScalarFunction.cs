...
public partial class NativeMethods
{
    public static unsafe class ScalarFunction
    {
        ...
        public static extern unsafe void DuckDBScalarFunctionSetName(IntPtr scalarFunction, SafeUnmanagedMemoryHandle name);
