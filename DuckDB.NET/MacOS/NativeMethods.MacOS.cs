...
namespace DuckDB.NET.MacOS
{
    ...
    {
        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_open")]
        public static extern DuckDBState DuckDBOpen(string path, out DuckDBDatabase database);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_close")]
        public static extern void DuckDBClose(out IntPtr database);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_connect")]
        public static extern DuckDBState DuckDBConnect(DuckDBDatabase database, out DuckDBNativeConnection connection);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_disconnect")]
        public static extern void DuckDBDisconnect(out IntPtr connection);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_query")]
        public static extern DuckDBState DuckDBQuery(DuckDBNativeConnection connection, string query, out DuckDBResult result);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_destroy_result")]
        public static extern void DuckDBDestroyResult(out DuckDBResult result);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_column_name")]
        public static extern string DuckDBColumnName(DuckDBResult result, long col);


        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_boolean")]
        public static extern bool DuckDBValueBoolean(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_int8")]
        public static extern sbyte DuckDBValueInt8(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_int16")]
        public static extern short DuckDBValueInt16(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_int32")]
        public static extern int DuckDBValueInt32(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_int64")]
        public static extern long DuckDBValueInt64(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_float")]
        public static extern float DuckDBValueFloat(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_double")]
        public static extern double DuckDBValueDouble(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_value_varchar")]
        public static extern string DuckDBValueVarchar(DuckDBResult result, long col, long row);

        [DllImport("libduckdb.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "duckdb_prepare")]
